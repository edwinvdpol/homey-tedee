 ...
 */
  ...
  async setNewSettings(data) {
    ...
    if (filled(data.isConnected)) {
      newSettings.status = data.isConnected
    ...
    // Merge settings
    const settings = Object.assign(newSettings, this.getNewSettings(data));
