...
class Device extends OAuth2Device {
  ...
  */
  ...
  cleanup() {
    ...
    this.homey.removeEventListener('tedee:clean', this.onClean);
    this.homey.removeEventListener('tedee:error', this.onError);
    this.homey.removeEventListener(`tedee:sync:${this.tedeeId}`, this.onSync);
  }
  ...
  async registerEventListeners() {
    ...
    this.onClean = this.cleanup.bind(this)

    this.homey.on('tedee:clean', this.onClean);
